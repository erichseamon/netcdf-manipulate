...
urltotal<-"http://inside-dev1.nkn.uidaho.edu:8080/thredds/dodsC/agg_met_pr_1979_2015_WUSA.nc?lon[0:1:1385],lat[0:1:584],daily_accumulated_precipitation[0:1:0][0:1:0][0:1:0],day[0:1:2]"
...
ncatt_get(nc,"daily_accumulated_precipitation")
...
var="daily_accumulated_precipitation"
